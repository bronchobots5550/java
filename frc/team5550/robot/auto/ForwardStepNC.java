...
public class ForwardStepNC extends Step{
	...
	public ForwardStepNC(AutoDriveRoutine routine, int inchesLeft, int inchesRight) {
		super(routine);
	...
	public ForwardStepNC(AutoDriveRoutine routine, int inches) {
		super(routine);
		leftDrive = routine.leftDrive;
		rightDrive = routine.rightDrive;
