...
public class ForwardWithElevatorStep extends Step{
	...
	public ForwardWithElevatorStep(AutoDriveRoutine routine, int inchesLeft, int inchesRight, int elevHeight, double activationPct) {
		super(routine);
	...
	public ForwardWithElevatorStep(AutoDriveRoutine routine, int inches, int elevHeight, double activationPct) {
		super(routine);
		leftDrive = routine.leftDrive;
		rightDrive = routine.rightDrive;
