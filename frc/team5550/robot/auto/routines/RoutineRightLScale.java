...
public class RoutineRightLScale extends AutoDriveRoutine{

	public RoutineRightLScale(TalonSRX leftDrive, TalonSRX rightDrive, Spark intakeLeft, Spark intakeRight, AHRS gyro, DigitalInput cubeSwitch, Elevator turboLift) {
		...
		this.addStep(new ForwardWithElevatorStep(this,195,195,Elevator.SWITCH_HEIGHT, .80));
		//this.addStep(new TurnStep(this, 90));
		//this.addStep(new ForwardStep(this,35, 25));
...
/*		this.addStep(new ForwardStep(this,235,235));
		...
		this.addStep(new TurnStep(this, 90));
		this.addStep(new ForwardStep(this, 30,40));
		this.addStep(new IntakeStep(this, true, 400));
*/
	}
