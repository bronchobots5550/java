...
public class RoutineRightLScaleStop extends AutoDriveRoutine{

	public RoutineRightLScaleStop(TalonSRX leftDrive, TalonSRX rightDrive, Spark intakeLeft, Spark intakeRight, AHRS gyro, DigitalInput cubeSwitch, Elevator turboLift) {
		...
		this.addStep(new ForwardStep(this,110,110));
