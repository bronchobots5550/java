...
public class RoutineRightSwitch extends AutoDriveRoutine{

	public RoutineRightSwitch(TalonSRX leftDrive, TalonSRX rightDrive, Spark intakeLeft, Spark intakeRight, AHRS gyro, DigitalInput cubeSwitch, Elevator turboLift) {
		...
		this.addStep(new ForwardStepNC(this,-44, 0));
