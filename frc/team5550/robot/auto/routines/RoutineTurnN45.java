...
public class RoutineTurnN45 extends AutoDriveRoutine {

	public RoutineTurnN45(TalonSRX leftDrive, TalonSRX rightDrive, Spark intakeLeft, Spark intakeRight, AHRS gyro, DigitalInput cubeSwitch, Elevator turboLift) {
		super(leftDrive, rightDrive, intakeLeft, intakeRight, gyro, cubeSwitch, turboLift);
		this.addStep(new TurnStep(this, -45));
	}
